...
export default async (req, res) =>
{
    if (req.method === 'GET')
    {
        ...
        WHERE "Appointment"."patientID" = 20 AND "Appointment"."appointmentID" = 7
        `)

        let totalroom = await db.query(`
        SELECT "roomName","RoomUse"."price","unit","unit" * "RoomUse"."price" AS "Total" FROM "public"."Appointment"
        ...
        WHERE "RoomUse"."price" != 0 AND "Appointment"."patientID" = 20 AND "Appointment"."appointmentID" = 7
        `)
        ...
        WHERE "DeviceWithdraw"."price_per_unit" != 0 AND "Appointment"."patientID" = 20 AND "Appointment"."appointmentID" = 7
        `)
        ...
        WHERE "MedicineWithdraw"."price_per_unit" != 0 AND "Appointment"."patientID" = 20 AND "Appointment"."appointmentID" = 7
        `)
